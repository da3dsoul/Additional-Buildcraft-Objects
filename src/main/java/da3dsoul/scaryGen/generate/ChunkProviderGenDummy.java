...
public class ChunkProviderGenDummy implements IChunkProvider {
	/** RNG. */
	private Random					rand;
	...
	public ChunkProviderGenDummy(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_) {
	...
	public void generateTerrain(int p_147424_1_, int p_147424_2_, Block[] blockArray) {
		byte b0 = 63;
		this.biomesForGeneration = this.worldObj.getWorldChunkManager().getBiomesForGeneration(
				this.biomesForGeneration, p_147424_1_ * 4 - 2, p_147424_2_ * 4 - 2, 10, 10);
	...
	@SuppressWarnings("unused")
	protected void func_147423_a(int p_147423_1_, int p_147423_2_, int p_147423_3_) {
		double d0 = 684.412D;
		double d1 = 684.412D;
		double d2 = 512.0D;
		double d3 = 512.0D;
		this.noiseGenDoubleArray1 = this.noiseGenOctaves6.generateNoiseOctaves(this.noiseGenDoubleArray1, p_147423_1_,
				p_147423_3_, 5, 5, 200.0D, 200.0D, 0.5D);
		this.noiseGenDoubleArray2 = this.noiseGenOctaves3.generateNoiseOctaves(this.noiseGenDoubleArray2, p_147423_1_,
				p_147423_2_, p_147423_3_, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
		this.noiseGenDoubleArray3 = this.noiseGenOctaves1.generateNoiseOctaves(this.noiseGenDoubleArray3, p_147423_1_,
				p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
		this.noiseGenDoubleArray4 = this.noiseGenOctaves2.generateNoiseOctaves(this.noiseGenDoubleArray4, p_147423_1_,
				p_147423_2_, p_147423_3_, 5, 33, 5, 684.412D, 684.412D, 684.412D);
		boolean flag1 = false;
		boolean flag = false;
		int l = 0;
