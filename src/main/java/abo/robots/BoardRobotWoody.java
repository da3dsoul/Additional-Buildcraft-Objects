...
public class BoardRobotWoody extends BoardRobotGenericBreakBlock {
    private static final int MAX_HARVEST_LEVEL = 3;
    private int harvestLevel = 0;

    public BoardRobotWoody(EntityRobotBase iRobot) {
        super(iRobot);
    ...
    public boolean isExpectedBlock(World world, int x, int y, int z) {
        ...
        return block != null && !block.isAir(world, x, y , z) && !BuildCraftAPI.getWorldProperty("wood").get(world, x, y, z) && block.getMaterial() == Material.wood;
    }
}
